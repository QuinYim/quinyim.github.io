...
author: dict = scholarly.search_author_id('NyUwUmIAAAAJ')
...
shieldio_data_mtl = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['NyUwUmIAAAAJ:bEWYMUwI8FkC']['num_citations']}",
}
...
shieldio_data_mnemonics = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['NyUwUmIAAAAJ:k_IJM867U9cC']['num_citations']}",
}
...
shieldio_data_aanets = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['NyUwUmIAAAAJ:u_35RYKgDlwC']['num_citations']}",
}
...
shieldio_data_e3bm = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['NyUwUmIAAAAJ:vV6vV6tmYwMC']['num_citations']}",
}
...
shieldio_data_lst = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['NyUwUmIAAAAJ:TFP_iSt0sucC']['num_citations']}",
}
